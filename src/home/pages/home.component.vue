        ...
        <div class="dashboard-grid">
          ...
          <div class="dashboard-card stats-card">
            ...
            <div class="card-content-admin">
              ...
              <div class="stat-item">
                ...
                <div class="stat-info">
                  <span class="stat-value">{{ menuItems?.length || 0 }}</span>
          ...
          <div class="dashboard-card actions-card">
            ...
            <div class="card-content">
              ...
              <router-link to="/menu" class="action-button">
...
import {MenuService} from "@/menu/service/menu.service.js";

const router = useRouter();
const headquarters = ref([]);
const menuItemsCount = ref(12); // temporal o mock
const categoryCount = ref(4);
const categoryList = 'Entradas, Principales, Postres, Bebidas';
...
onMounted(async () => {
  try {
    ...
    const menuResponse = await menuService.getAllMenuItems();
